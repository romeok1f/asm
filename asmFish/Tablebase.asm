...
;SD_String db 'probe_dtz_no_ep() wdl='
;SD_Int r14
;SD_String db 10
...
test eax, eax
jnz  @f
SD_String <db 'root_probe false', 10>
add rsp, .localsize
pop r15 r14 r13 r12 rdi rsi rbx
ret
@@:
...
test eax, eax
jnz  @f
SD_String db 'root_probe_wdl false'
SD_NewLine
pop r15 rdi rsi
ret
@@:
...
jmp   .printnext
.printdone:
SD_String db 'root_probe_wdl true'
SD_NewLine
or eax, -1
pop r15 rdi rsi
ret
